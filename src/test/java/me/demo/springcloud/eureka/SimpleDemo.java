...
public class SimpleDemo {
    ...
    public void aboutMetaData() throws InterruptedException, JSONException {
        ...
        JSONObject clientInof = new JSONArray(forEntity.getBody()).getJSONObject(0);

        Assert.assertEquals("customizedValue",
                            clientInof.getJSONObject("metadata").getString("mykey"));
        Assert.assertEquals("add_when_initial",
                            clientInof.getJSONObject("metadata").getString("addByCodeMeta"));
